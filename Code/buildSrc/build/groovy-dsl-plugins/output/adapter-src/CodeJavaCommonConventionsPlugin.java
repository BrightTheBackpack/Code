...
/**
 * Precompiled Code.java-common-conventions script plugin.
 **/
public class CodeJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_CodeJavaCommonConventions").asSubclass(BasicScript.class);
